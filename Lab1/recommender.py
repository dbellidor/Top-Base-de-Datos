...
class recommender:
	...
	if self.metric == 'cos_similar':
            self.fn = self.cos_similar
        #
    ...
    def include_all_occurrences(self,rating1,rating2):
        vector_x = []
        vector_y = []
    ...
    def create_vectors(self,rating1, rating2):
        vector_x = []
        vector_y = []
    ...
    def cos_similar(self,rating1, rating2):
        vec_length_1 = 0
        vec_length_2 = 0
        dot_product = 0

        self.include_all_occurrences(rating1, rating2)

        # print("rating1 ==> ", rating1)

        x,y = self.create_vectors(rating1, rating2)
